  ...
  return (
    <View style={{backgroundColor: 'white'}}>
      ...
      <ScrollView horizontal={true} style={{height: 150}}>
        ...
        <TouchableOpacity
          onPress={() => {
            alert('Santri Mandiri ada 83 orang');
          }}>
          <View
            style={{
              backgroundColor: '#00ffff',
        ...
        <TouchableOpacity
          onPress={() => {
            alert('Santri Belum Mandiri 71 orang');
          }}>
          <View
            style={{
              backgroundColor: '#00ffff',
            ...
            <Text style={{marginTop: 0, marginLeft: 40, fontSize: 15}}>
              Mandiri
            </Text>
          </View>
        </TouchableOpacity>
      ...
      <View style={{flexDirection: 'row', backgroundColor: '#94EDEE'}}>
        ...
        <TouchableOpacity onPress={() => alert('transaksi')}>
          <View
            style={{
              backgroundColor: '#94EDEE',
              width: 125,
        ...
        <TouchableOpacity onPress={() => alert('succes')}>
          <View
            style={{
              backgroundColor: '#94EDEE',
              width: 125,
      ...
      <View
        ...
        <TouchableOpacity onPress={() => alert('kevin')}>
          <View
            style={{
              backgroundColor: '#94EDEE',
              width: 125,
